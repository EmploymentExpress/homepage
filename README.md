...
- **Short job-details headlines** — generated as `<Department short name> <Total posts> <Post name(s)> <What the notice is about>` capped at 72 characters, where the department name is always in **capital letters** (e.g. `PULSA`, `PAU`, `INDIAN ARMY`, `HARYANA WCD`, `LOCAL AUDIT DEPT.`).
